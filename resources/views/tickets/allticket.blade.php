...
<div class="col-12">
    <div class="card">
        ...
        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
            <h4 class="m-0 font-weight-bold text-primary">{{ __('messages.ticket_list') }}</h4>
        </div>
                ...
                <table class="table table-bordered" id="example">
                    ...
                    <tbody class="table-border-bottom-0">
                        ...
                        <tr>
                            ...
                            <!-- <td>{{ $tt->latestTicketlog->ticstatus->ticstatus_label ?? " " }}</td> -->
                            <!-- <td>{{ $tt->ticstatus->ticstatus_label ?? " " }}</td>    -->                            
                            <!-- <td>
                                @if(null !== ($lateststatusLabel = $tt->latestTicketlog->ticstatus->ticstatus_label ?? null))
                                    @php
                                        $badgeClass = '';

                                        switch($tt->latestTicketlog->ticstatus->id ?? null) {
                                            case 1:
                                                $badgeClass = 'bg-success';
                                                break;
                                            case 2:
                                    ...
                                    <span class="badge {{ $badgeClass }} me-1">{{ $lateststatusLabel }}</span>
                                @else
                                    <span class="badge bg-secondary me-1"></span>
                                @endif
                            </td>   badges that depends on database -->   
                            ...
                            <td>
                                <form action="" method="POST">
                                    ...
                                    <a class="menu-icon tf-icons bx bx-archive" href="{{ route('tickets.allticketedit',$tt->id) }}" style="color:#57cc99"
