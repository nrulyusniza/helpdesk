...
<div class="col-12">
    <div class="card">
        ...
        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
            <h4 class="m-0 font-weight-bold text-primary">{{ __('messages.edit_reportingperson') }}</h4>
        </div>
            ...
            <form action="{{ route('reportingpersons.listreportingpersonupdate',['reportingperson' => $reportingperson->id]) }}" method="POST">
                ...
                <div class="row">
                    ...
                    <div class="mb-3 col-md-6">
                        ...
                        <input type="number" class="form-control" name="rptpers_mobile" value="{{ $reportingperson->rptpers_mobile }}">
                    </div>
                    <div class="mb-3 col-md-6">
                    ...
                    <div class="mt-2">
                        ...
                        <a type="cancel" class="btn btn-outline-secondary" href="{{ route('reportingpersons.listreportingperson') }}">{{ __('messages.cancel') }}</a>
                    </div>
                </div>
            </form>
        </div>
