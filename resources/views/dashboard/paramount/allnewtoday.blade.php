                                    ...
                                    @if ($antd->ticketlog->isNotEmpty())
                                        @foreach ($antd->ticketlog as $log)                                 
                                            <tr>
                                                ...
                                                <!-- <td>{{ \Carbon\Carbon::parse($antd->report_received)->format('d/m/Y h:i A') }}</td> -->
                                                ...
                                                <!-- <td>{{ $antd->expected_closure_time ? $antd->expected_closure_time->format('d/m/Y h:i A') : 'N/A' }}</td> -->
                                                <td>
