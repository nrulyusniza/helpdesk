    ...
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ route('reqcategorys.update',$reqcategory->id) }}" method="POST">
                ...
                @method('PUT')
                <div class="row mb-3">
                    <label class="col-sm-2 col-form-label" for="req_category">Request Category</label>
                    <div class="col-sm-10">
                ...
                <div class="row justify-content-end">
                    <div class="col-sm-10">
                        ...
                        <a class="btn btn-outline-secondary" href="{{ route('reqcategorys.allreqcategory') }}">Cancel</a>
                    </div>
                </div>
            </form>
        </div>
