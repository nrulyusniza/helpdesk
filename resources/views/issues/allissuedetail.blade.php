        ...
        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
            ...
            <div class="btn-text-right">
                <a href="{{ route('issues.allresponse',['issue' => $issue->id]) }}"
                    <button type="button" class="btn btn-primary"><i class='bx bx-edit'></i>&nbsp; {{ __('messages.admin_response') }}</button>
                </a>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="mb-3 col-md-6">
                    ...
                    @if ($issue->attachment)
                        ...
                        <a href="{{ asset('storage/' . $issue->attachment) }}" target="_blank">{{ basename($issue->attachment) }}</a>
                    @else
                ...
                <div class="mt-2">
                    <a type="cancel" class="btn btn-outline-secondary" href="{{ route('issues.allissue') }}">{{ __('messages.back') }}</a>
                </div>                        
            </div>
