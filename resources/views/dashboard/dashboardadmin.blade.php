...
<div class="row g-4 mb-4">
  ...
  <div class="col-sm-6 col-xl-3">
    <a href="{{ route('dashboard.infohub.listticket') }}">
      <div class="card">
        <div class="card-body">
  ...
  <!-- 2 -->
  <div class="col-sm-6 col-xl-3">
    <a href="{{ route('dashboard.infohub.listopen') }}">
      <div class="card">
        <div class="card-body">
          <div class="d-flex align-items-start justify-content-between">
            <div class="content-left">
  ...
  <!-- 3 -->
  <div class="col-sm-6 col-xl-3">
    <a href="{{ route('dashboard.infohub.listclosed') }}">
      <div class="card">
        <div class="card-body">
          <div class="d-flex align-items-start justify-content-between">
            <div class="content-left">
  ...
  <!-- 4 -->
  <div class="col-sm-6 col-xl-3">
    <a href="{{ route('dashboard.infohub.listkiv') }}">
      <div class="card">
        <div class="card-body">
          <div class="d-flex align-items-start justify-content-between">
            <div class="content-left">
