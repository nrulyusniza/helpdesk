...
<div class="col-12">
    <div class="card">
        ...
        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
            <h4 class="m-0 font-weight-bold text-primary">{{ __('messages.ticket_list') }}t</h4>
        </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <form action="" method="POST">
                                    ...
                                    <a class="menu-icon tf-icons bx bx-archive" href="{{ route('tickets.entireticketlog',$tt->id) }}" style="color:#57cc99"
