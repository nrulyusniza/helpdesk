        ...
        <div class="card-body">            
            <div class="row">
                ...
                <div class="col-xl">
                    <div class="card mb-4">
                        <div class="card-body">
                            <form action="{{ route('tickets.allticketupdate',['ticket' => $ticket->id]) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                <div class="mb-3">
            ...
            <div class="mt-2">
                <a type="cancel" class="btn btn-outline-secondary" href="{{ route('tickets.allticket') }}">{{ __('messages.back') }}</a>
            </div>  
